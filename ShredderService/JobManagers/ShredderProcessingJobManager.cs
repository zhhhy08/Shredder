namespace Microsoft.WindowsAzure.Governance.ResourcesCache.ShredderService.JobManagers
{
    ...
    /// <seealso cref="JobManagement.JobManager.JobManager{ShredderProcessingJobContext, ShredderProcessingMessage}" />
    internal class ShredderProcessingJobManager : JobManager<ShredderProcessingJobContext, ShredderProcessingMessage>
    {
        #region Tracing

        private static readonly MetricActivityMonitorFactory ShredderProcessingJobManagerDoWorkAsync =
            new MetricActivityMonitorFactory("ShredderProcessingJobManager.DoWorkAsync",
        ...
        private static readonly MetricActivityMonitorFactory ShredderProcessingJobManagerAssignAndStartJobsAsyncFactory =
            new MetricActivityMonitorFactory("ShredderProcessingJobManager.AssignAndStartJobsAsync",
        ...
        protected override MetricActivityMonitorFactory DoWorkAsyncFactory =>
            ShredderProcessingJobManagerDoWorkAsync;

        protected override MetricActivityMonitorFactory AssignAndStartJobsAsyncFactory =>
            ShredderProcessingJobManagerAssignAndStartJobsAsyncFactory;
        ...
        /// <summary>
        /// Initializes the <see cref="ShredderProcessingJobManager"/> class.
        /// </summary>
        [SuppressMessage(
            "Microsoft.Performance",
            "CA1810:InitializeReferenceTypeStaticFieldsInline",
            Justification = "Need initialization of non explicit static fields")]
        static ShredderProcessingJobManager()
        {
            RetryStrategy = new ExponentialBackoff(
                ServiceConfiguration.Current.Get<int>(
                    ServiceConfigConstants.ShredderSection,
                    ConfigurationConstants.ShredderProcessingJobManagerMaxQueueMessageDequeueCountEntry),
                TimeSpan.Zero,
                TimeSpan.Parse(
                    ServiceConfiguration.Current.Get(
                        ServiceConfigConstants.ShredderSection,
                        ConfigurationConstants.ShredderProcessingJobManagerQueueMessageMaxVisibilityTimeoutEntry)),
                TimeSpan.Parse(
                    ServiceConfiguration.Current.Get(
                        ServiceConfigConstants.ShredderSection,
                        ConfigurationConstants.ShredderProcessingJobManagerDeltaQueueMessageVisibilityTimeoutEntry)));
        }

        public ShredderProcessingJobManager(int threadPoolLimit,
            IQueue<ShredderProcessingMessage> jobQueue,
            IQueue<ShredderProcessingMessage> poisonJobQueue)
            : base(threadPoolLimit,
                ...
                ServiceConfigConstants.ShredderSection,
                ConfigurationConstants.ShredderServiceProcessingQueuePollingPeriod)))
        {
        ...
        /// Creates the job.
        /// </summary>
        protected override Job<ShredderProcessingJobContext> CreateJob()
        {
            return new ShredderProcessingJob();
        }

        protected override Task<ShredderProcessingJobContext> CreateJobContextAsync(
                    IQueueMessage<ShredderProcessingMessage> queueMessage, IActivity parentActivity)
        {
            return Task.FromResult(
                    JobContextFactory.Instance.CreateShredderProcessingJobContext(
                        this.JobQueue,
                        AzureQueueFactory.Instance.SnapshotNotificationRetryQueue,
                        queueMessage,
